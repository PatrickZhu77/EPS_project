...
void INA226_SetCalReg(i2cBASE_t *i2c, uint8_t addr,uint8_t *data)
{
...
//read id
void INA226_GetID(i2cBASE_t *i2c, uint8_t addr, uint8_t *data)
{
    //int err = -1;
    uint8_t temp = 0;
...
void INA226_GetCalReg(i2cBASE_t *i2c, uint8_t addr, uint8_t *data)
{
    //int err = -1;
    uint8_t temp = 0;
